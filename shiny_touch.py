...
execfile(os.getcwd()+"/shinytouch/performance.py")
execfile(os.getcwd()+"/shinytouch/perspective.py")
execfile(os.getcwd()+"/shinytouch/graphics.py")
execfile(os.getcwd()+"/shinytouch/callibrate.py")
